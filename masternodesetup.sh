...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mnbtc.conf'
CONFIGFOLDER='/root/.mnbtc'
COIN_DAEMON='mnbtcd'
COIN_CLI='mnbtc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/mnbtc/mnbtc/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
